 ...
 */
function findLargerOrTie(numA, numB) {
  if (numA === numB){
    return "tie"
 ...
 */
function positiveNegativeOrZero(numA) {
   if (numA > -0){
      return "Positive";}
     else if (numA < -0){
          return "Negative";}
 ...
 */
 const animalCounts = (animal, numberOfAnimals) => {       if (numberOfAnimals > 1){       return numberOfAnimals + " " + animal + "s"     }else {       return numberOfAnimals + " " + animal     }   } 
